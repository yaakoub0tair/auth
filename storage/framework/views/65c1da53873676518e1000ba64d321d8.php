...
<div class="border rounded-lg p-4 <?php echo e($current['bg']); ?> relative" role="alert">
    <!-- Contenu avec icône -->
    <div class="flex items-start">
        <!-- Icône -->
        <div class="flex-shrink-0">
            <svg class="h-5 w-5 <?php echo e($current['icon']); ?>" viewBox="0 0 20 20" fill="currentColor">
        ...
        <?php if($dismissible): ?>
            <div class="ml-auto pl-3">
                <button 
                    type="button" 
                    class="inline-flex p-1.5 rounded-md <?php echo e($current['button']); ?> transition-colors duration-200"
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/auth/resources/views/components/alert.blade.php ENDPATH**/ ?>